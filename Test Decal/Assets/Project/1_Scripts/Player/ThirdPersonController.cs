...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        [Header("Camera Transition Smoothness")]
        [Tooltip("Higher = faster adaptation to new fixed camera angles")]
        ...
        private void Awake()
        {
            // Try to get the current camera (can be main or managed)
            if (_mainCamera == null)
            {
        ...
        private void Update()
        {
            ...
            // If using a CameraManager, update current camera
        ...
        private void Move()
        {
            ...
            // --- NEW CAMERA SMOOTH DIRECTION ---
            if (_mainCamera == null) return;

            // we take the current camera forward and right axes
            Vector3 camForward = _mainCamera.transform.forward;
            Vector3 camRight = _mainCamera.transform.right;
            // ignore vertical (so player remains on ground)
            camForward.y = 0;
            camRight.y = 0;
            ...
            // calculated rotation is applied to obtain the final displacement vector
